...
class EducationModel extends Model
{
    ...
    {
        $this->db->query("SELECT * FROM education WHERE user_id = :user_id");
    ...
    public function InsertEducation(object $data)
    {
    ...
    // SAVE ANY UPDATING DATA FROM ANY TABLE
    public function UpdateEducation(object $data)
    {
        // SET THE PART 1 OF THE QUERY AND THE TABLE NAME WILL COME FROM CONTROLLER 
        $query = 'UPDATE education SET start_date = :start_date,
    ...
    {
        $this->db->query('DELETE FROM education WHERE id = :id');
        $this->db->bind(':id', $id);
