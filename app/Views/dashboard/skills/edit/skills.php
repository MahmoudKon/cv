            ...
            <?php foreach($data as $skill) : ?>
                    <div class="input-group body col-12 px-0 mb-1" data-repeater-item="">
                        ...
                        <div class="col-8">
                            ...
                            <input type="text" placeholder="Web Developer" class="form-control" name="skill" minlength="3" maxlength="40" id="skill" value="<?= $skill->skill ?>" required>
                        </div>
                        <div class="col-3">
                            <label id="skill"> Skill Level :</label>
                            <input type="number" placeholder="Set Your Level From 1 To 5" class="form-control" pattern="[1-5]{1}" name="level" id="level" value="<?= $skill->level ?>" required>
                        </div>
                        <div class="col-1">
