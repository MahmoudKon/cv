<div id="kick-start" class="card border-pink">
    <div class="card-header bg-pink bg-darken-4 text-white">
        <h4 class="card-title text-white">Awards</h4>
        ...
        <div class="card-body">
            <div class="card-text">
                <?php if(isset($data->general->awards)) : ?>
                    <p><?php echo htmlspecialchars_decode($data->general->awards, ENT_NOQUOTES); ?></p>
                <?php else : ?>
