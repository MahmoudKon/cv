...
<div class="card bg-transparent border-cyan">
    <!-- Start The Header Of Timeline Section -->
    <div class="card-header bg-cyan border-darken-4 text-white">
        ...
        <div class="heading-elements">
            <ul class="list-inline mb-0">
                ...
                <li><a href="<?= URL('dashboard/profile/edit/' . auth()->id) ?>">
                        <i class="ft-edit"></i></a>
                </li>
            </ul>
        </div>
