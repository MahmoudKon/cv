...
<div class="col-md-7">
    ...
    <div class="form-group mb-2">
        ...
        <input type="date" class="form-control"
                name="education[0][end_date]" id="end_date" required>
    </div>
    <!-- Degree Name Input -->
    <div class="form-group mb-2">
    ...
    <div class="form-group mb-2">
        ...
        <input type="text" class="form-control" name="education[0][place]"
...
<div class="col-md-5">
    <div class="form-group mb-2">
        ...
        <div id="basic">
            <textarea name="education[0][description]" placeholder="Write Some Words About This Education" class="form-control form-group-sm" cols="30"
