...
<div class="input-group col-12 p-2 mb-1 border-danger" data-repeater-item="">
    <input type="hidden" value="<?= $edu->id ?>" name="id" required>
    <!-- End Date & Place Name Inputs & Start Date & Degree Name Inputs -->
    <div class="col-md-7">
        <!-- Start Date Input -->
        <div class="form-group mb-2">
            <label id="start_date"> Start Date</label>
            <input type="date" value="<?= $edu->start_date ?>" class="form-control" 
        ...
        <div class="form-group mb-2">
            ...
            <input type="date"  value="<?= $edu->end_date ?>" class="form-control"
        ...
        <div class="form-group mb-2">
            ...
            <input type="text"  value="<?= $edu->degree ?>" class="form-control"
        ...
        <div class="form-group mb-2">
            ...
            <input type="text"  value="<?= $edu->place ?>" class="form-control"
