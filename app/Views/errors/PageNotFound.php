...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= assets('backend/app-assets/css/pages/error.css'); ?>">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?= assets('backend/assets/css/style.css'); ?>">
    <!-- END Custom CSS-->
</head>
...
<body class="vertical-layout vertical-menu-modern 1-column   menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-md-4 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                ...
                                <h3 class="text-uppercase text-center mb-2">Page Not Found !</h3>
                                <a href="#" onclick="history.back(); return false;" class="btn btn-primary btn-block"><i class="ft-repeat"></i> Back</a>
                            </div>
                    </div>
                </section>
            </div>
    ...
    <script src="<?= assets('backend/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js'); ?>" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN MODERN JS-->
    ...
    <!-- END MODERN JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?= assets('backend/app-assets/js/scripts/forms/form-login-register.js'); ?>" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
</body>
